...
```{r fig.width = 6, fig.height = 4, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	strain_info = strain_info %>%
	  ...
	  mutate(epoch_1 = as.numeric(off_epoch=="epoch_1")) %>%
	  mutate(epoch_2 = as.numeric(off_epoch=="epoch_2")) %>%
	  mutate(epoch_3a = as.numeric(off_epoch=="epoch_3a")) %>%
	  mutate(epoch_3b = as.numeric(off_epoch=="epoch_3b")) %>%
	  mutate(epoch_4 = as.numeric(off_epoch=="epoch_4")) %>%
	  mutate(epoch_5 = as.numeric(off_epoch=="epoch_5")) %>%
	  mutate(epoch_6 = as.numeric(off_epoch=="epoch_6")) %>%
	  mutate(epoch_7 = as.numeric(off_epoch=="epoch_7"))
