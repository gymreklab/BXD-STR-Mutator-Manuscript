...
#. Include *all* motif lengths for the GW scan. 
#. TODO: should we do only tetra?
#. TODO: epoch as a covariate?
#. TODO: num generations maybe doesn't need to be a covariate for % expanded and mutation size?
#. TODO: check updated gen inbreeding info
...
#. TODO: this is also only looking at motif_len == 4
...
p = perc_exp_byhap %>%
  ...
  geom_quasirandom(dodge.width = 0.9, width=0.2, groupOnX = TRUE) +
  geom_boxplot(
					 fill = 'white', alpha=0, 
