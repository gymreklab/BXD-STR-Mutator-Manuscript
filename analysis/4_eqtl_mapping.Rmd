...
```{r echo=TRUE, fig.width = 8, fig.height = 4, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	p
	ggsave('../pdfs/SuppFig17_GeneExpressionDatasets.pdf', p, w = 8, h = 4)
```
...
```{r echo=TRUE, fig.width = 10, fig.height = 6, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	# save figure
	ggsave('../pdfs/SuppFig16_eQTLSubsets.pdf', p, w = 10, h = 6)
```
...
```{r echo=TRUE, fig.width = 14, fig.height = 10, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	ggsave('../pdfs/SuppFig19_eQTLSummary.pdf', p_filt, w = 14, h = 10)
```
...
# QTL data on %expanded phenotype for all strains
	...
	p
	ggsave('../pdfs/SuppFig21_MoreCo-localization_a.pdf', p, w = 8, h = 5)
```
...
```{r echo=TRUE, fig.width = 8, fig.height = 5, fig.align = 'center', cache = TRUE, eval = TRUE}
	p = qtl_eqtl_mark_cor %>%
		...
		theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
	p
	ggsave('../pdfs/SuppFig21_MoreCo-localization_b.pdf', p, w = 8, h = 5)
...
```{r echo=TRUE, fig.width = 8, fig.height = 4, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	p
	ggsave('../pdfs/SuppFig21_MoreCo-localization_c.pdf', p, w = 8, h = 4)
```
...
```{r echo=TRUE, fig.width = 10, fig.height = 4, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	p = ggplot() +
		...
		labs(x = 'Mb')
	p
	ggsave('../pdfs/SuppFig20_DetailedEQTLDNARepair.pdf', p, w = 10, h = 4)
