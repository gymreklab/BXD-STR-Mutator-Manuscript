...
#ci_chr = '13'; ci_lo = 87.58; ci_hi = 93.42; ci_mid = 90.44
# qtl_ci = tibble('metric' = '% expanded', 'ci_lo' = ci_lo, 'pos' = ci_mid, 'ci_hi' = ci_hi)
...
```{r echo=TRUE, fig.width = 6, fig.height = 4, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	ft
	save_as_html(ft, path = fs::path('../pdfs/', 'Suppl_Tbl_2.html'))
	# save_as_image(x = ft , path = path('../pdfs/', 'Suppl_Tbl_2.pdf'))
...
```{r echo=TRUE, fig.width = 6, fig.height = 4, fig.align = 'center', cache = TRUE, eval = TRUE, results='asis'}
  ...
  # create a function for reducing for plotting data
	...
	ret$ft_obj
	ret$smry
	ret$ft_obj %>% save_as_html(path = fs::path('../pdfs/', 'Suppl_Tbl_1.html'))
	# save_as_image(x = ret$ft_obj , path = path('../pdfs/', 'Suppl_Tbl_1.pdf'))
```
...
```{r echo=TRUE, fig.width = 9, fig.height = 8, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	ggsave(fs::path('../pdfs/', 'Suppl_Fig_9.pdf'), p, w = 9, h = 8)
...
```{r echo=TRUE, fig.width = 12, fig.height = 12, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	# figure print
	ggsave(fs::path('../pdfs/', 'Suppl_Fig_13.pdf'), p, w = 12, h = 12)
```
...
```{r echo=TRUE, fig.width = 16, fig.height = 5, fig.align = 'center', cache = TRUE, eval = TRUE}
	...
	ft
    save_as_html(ft, path = fs::path('../pdfs/', 'Suppl_Tbl_4.html'))
